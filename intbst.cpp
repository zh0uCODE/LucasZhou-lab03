...
bool IntBST::remove(int value){
  ...
  if (n->left == nullptr && n->right == nullptr) { //no children
    if (n == root) { //n is the root
      ...
      root = nullptr; //define root to be null
      n = nullptr; //no dangling!
